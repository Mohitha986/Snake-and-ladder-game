...
public class Util {
 ...
 // public static void stepsOnAnotherPlayer(WorkFlow workFlow) {
 //       if(workFlow.turnFirstPlayer)
  //      	if(workFlow.player1.position == workFlow.player2.position) {
 //           	System.out.println(workFlow.player1.name + " should go to initial position " + workFlow.newPosition.x + ", " + workFlow.newPosition.y);            	
 //          }else {

  //         	System.out.println(workFlow.player2.name + " should go to initial position " + workFlow.newPosition.x + ", " + workFlow.newPosition.y);            	
  //          
   //        }
   // }
